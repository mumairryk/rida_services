...
class UserAdress extends Model
{
    ...
    public static function get_user_default_address($userid)
    {
        ...
        $adress = UserAdress::where(['status' => 1, 'user_id' => $userid])->select('user_address.id', 'street', 'user_address.location', 'user_address.address_type', 'is_default', 'land_mark', 'building', 'latitude', 'longitude','apartment')

...
class OrderModel extends Model
{
  ...
  public function products(){
   ...
   public function driver(){
    return $this->hasOne(User::class, 'id', 'driver_id')->select(['id','name','user_image','dial_code','phone'])->withDefault(['id'=>'0','name'=> '','user_image'=>'','dial_code'=>'','phone'=>'']);
   }
   public function store(){
    return $this->hasOne(User::class, 'id', 'store_id');
   }
   public function deligate(){
    return $this->hasOne(DeligateModel::class, 'id', 'request_deligate');
   }

...
class IndividualsController  extends Controller
{
    ...
    public function index()
    {
        ...
        $datamain = VendorModel::select('*', 'users.name as name', 'industry_types.name as industry', 'users.active as active', 'users.id as id', 'users.updated_at as updated_at')
            ->where(['user_type_id' => '3', 'users.deleted' => '0'])
            //->with('vendordata')
        ...
        return view('admin.individuals.list', compact('page_heading', 'datamain'));
    }
    ...
    public function create()
    {
        ...
        return view("admin.individuals.create", compact('page_heading', 'industry', 'accountTypes', 'id', 'name', 'dial_code', 'active', 'prefix', 'countries', 'states', 'cities', 'banks', 'banks_codes', 'business_infos'));
    }
            ...
            if (empty($check_exist)) {
                ...
                if (empty($check_exist_phone)) {
                    ...
                    if ($request->id != "") {
                        ...
                        $status = "1";
                        $message = "Individual updated succesfully";
                    } else {
    ...
    public function edit($id)
    {
        ...
        if ($datamain) {
            ...
            return view("admin.individuals.create", compact('page_heading', 'datamain', 'accountTypes', 'id', 'countries', 'states', 'cities', 'user_image', 'industry', 'banks', 'banks_codes', 'business_infos','location'));
        } else {
            abort(404);
        }
    }

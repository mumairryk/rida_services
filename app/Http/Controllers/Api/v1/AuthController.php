...
class AuthController extends Controller
{
    ...
    public function signup_old(Request $request)
    {
        ...
        $user = new User([
            ...
            'user_phone_otp' => rand(1000, 9999),
            'user_email_otp' => rand(1000, 9999),
            'role' => 2,
            'phone_verified' => 0,
            'active' => 1,
        ]);
        ...
        // $messagen = "OTP to confirm The HOP registration is " . $user->user_phone_otp;
    ...
    public function resend_code(Request $request)
    {
        ...
        $user->user_email_otp = rand(1000, 9999);
    ...
    public function resend_phone_code_old(Request $request)
    {
        $user = User::where('id', $request->user_id)->first();

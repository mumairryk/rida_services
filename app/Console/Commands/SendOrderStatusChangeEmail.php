...
class SendOrderStatusChangeEmail extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:send_order_status_change_email {--uri=} {--uri2=} {--uri3=} {--uri4=} {--uri5=}';
     ...
     * @var string
     */
    protected $description = 'Send Order Status Change Email';
    ...
    public function handle()
    {
        ...
        $ord_status = urldecode($this->option("uri5"));
        ...
        $o_data = $order;
        $mailbody = view('emai_templates.order_status_changes', compact('order', 'name','ord_status'));

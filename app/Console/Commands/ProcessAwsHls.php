                        ...
                        foreach($media_convert_job_ids as $job_id) {
                            ...
                            if($job_result) {
                                ...
                                if($job_status == "PROGRESSING" || $job_status == "SUBMITTED") {
                                    ...
                                    $post_file->hls_url = "https://moda-staging.s3.ap-southeast-1.amazonaws.com/processed/".$my_job_ids[$job_id]."/".$my_job_ids[$job_id]."/".$my_job_ids[$job_id].".m3u8";
                ...
                [
                    ...
                    "OutputGroupSettings" => [
                        ...
                        "HlsGroupSettings" => [
                            ...
                            "Destination" => "s3://moda-staging/".$output_key_prefix."".$raw_file_name."/",
                            "DestinationSettings" => [
                                "S3Settings" => [
                                    "AccessControl" => [

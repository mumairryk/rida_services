   ...
   @endif
        <div class="card-header">
            ...
            <div class="status d-flex justify-content-end ">
                ...
                <a href="{{ url('vendor/import_export') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-download"></i> Import</a>
                ...
                <input type="hidden" name="from" value="{{$from}}"> 
                 <button type="submit" class="btn btn-danger mr-2 btn-rounded" style="display:none;">Export</button> 
            </div>
        </form>
                </div>

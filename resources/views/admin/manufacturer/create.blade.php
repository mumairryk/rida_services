...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            ...
            <form method="post" id="admin-form" action="{{ url('admin/manufacturer_save') }}" enctype="multipart/form-data" data-parsley-validate="true">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" required
                                    data-parsley-required-message="Enter Country Name" value="">
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="form-group">

...
<div class="card mb-5">
    @if(check_permission('reservations','Create'))
    <div class="card-header"><a href="{{url('admin/reservations/create')}}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Reservations</a></div>
    @endif
    <div class="card-body">
                        ...
                        <td>
                            <label class="switch s-icons s-outline  s-outline-warning mb-2 mt-2 mr-2">
                                        <input type="checkbox" class="change_status" data-id="{{ $datarow->id }}"
                                            data-url="{{ url('admin/reservations/change_status') }}"
                        ...
                        <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    @if(check_permission('reservations','Edit'))
                                    <a class="dropdown-item" href="{{url('admin/reservations/'.$datarow->id.'/edit')}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    
                                    @if(check_permission('reservations','ChangePassword'))
                                    ...
                                    @endif
                                    @if(check_permission('reservations','Delete'))
                                    <a class="dropdown-item" data-role="unlink"
                                    data-message="Do you want to remove this Vendor?"
                                    href="{{ url('admin/reservations/' . $datarow->id) }}"><i
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = App.siteUrl('/admin/reservations');
                        }, 1500);
                    }

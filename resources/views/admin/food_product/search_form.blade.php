    ...
    <div class="row">
        <div class="col-md-3 form-group">
            ...
            $filters = [
             ...
             ?>
            <select class="form-control jqv-input product_cat" data-jqv-required="true" name="sort_type"
                data-role="select2" data-placeholder="Select Filter" data-allow-clear="true">
        ...
        <div class="col-md-3 form-group">
            ...
            <select class="form-control jqv-input product_cat select2" data-jqv-required="true" name="category"
                data-role="select2" data-placeholder="Select Categories" data-allow-clear="true">
                ...
                <optgroup label="<?php echo $parent_cat_name; ?>"
                ...
                <optgroup label="<?php echo str_repeat('&nbsp;', 4) . $sub_cat_name; ?>"
                    <?php echo in_array($sub_cat_id, $category_ids) ? 'selected' : ''; ?>>
                ...
                <optgroup label="<?php echo str_repeat('&nbsp;', 6) . $sub_cat_name2; ?>"
                    <?php echo in_array($sub_cat_id2, $category_ids) ? 'selected' : ''; ?>>
                ...
                @else
                <option value="<?php echo $sub_cat_id2; ?>"
                    <?php echo in_array($sub_cat_id2, $category_ids) ? 'selected' : ''; ?>>
        ...
        <div class="col-md-2 form-group">
            <label>Name</label>
            <input type="search" name="search_key" class="form-control form-control-sm" placeholder=""
                aria-controls="column-filter" value="{{ $search_key }}">
        </div>
        <div class="col-md-4 mt-4">

            @if($from || $to || $category || isset($_GET['search_key']) || $store_id)
            <a type="button" href="{{url('admin/food_products')}}" class="btn btn-primary float-right ml-2">Reset</a>
            @else

...
<div class="mb-5">
    ...
    <form method="post" id="admin-form" action="{{ url('admin/groomers') }}" enctype="multipart/form-data"
        ...
        <div class="modal-body">
          <form method="post" action="" id="event-from">
              <div class="from-group">
                  ...
                  <input type="hidden" name="groomer_id" value="{{ $id }}">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      eventClick: function(arg) {
        ...
        //     {
        //         type:"POST",
        //         url: '{{url("admin/groomers/remove_event")}}',
      ...
      eventSources:[
        {
            url: '{{url("admin/groomers/get_events")}}',
            method: 'POST',
            extraParams: {
                un_id: '{{$un_id}}',
                'groomer_id':'{{ $id }}'
    ...
    $('#event-from').submit(function(e){
        ...
        $.ajax({
             url:"{{url('admin/groomers/add_event')}}",
             type:"post",

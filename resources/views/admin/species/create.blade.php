...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="col-xs-12">
                <form method="post" id="admin-form" action="{{ url('admin/save_species') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Species Name<b class="text-danger">*</b></label>
                                <input type="text" name="name" class="form-control" required
                                    data-parsley-required-message="Enter species Name" value="{{ $name }}">
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = App.siteUrl('/admin/species');
                        }, 1500);

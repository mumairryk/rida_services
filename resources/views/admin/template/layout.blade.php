            ...
            <nav class="sidebar-nav">
                <ul>
                   ...
                   <!--  @if(check_permission('adminusers','View') || check_permission('admin_user_desig','View'))
                    ...
                    check_permission('project_purpose','View') || check_permission('project_purpose','View') || check_permission('hash_tags','View'))

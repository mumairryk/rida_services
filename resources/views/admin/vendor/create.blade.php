                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-12 col-xs-12" style="display: block">
                                            <div class="form-group">
                                                <label>Holiday Dates </span></span></label>
                                                <input type="text" class="form-control  flatpickr-multiple"  name="holiday_dates" value="@if($datamain->holidays)  {{$datamain->holidays }} @endif"  data-parsley-required-message="Enter Holiday Dates"  readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="card mt-4 weekly" style="border-radius: 5px; overflow: hidden;" >
                                            <div class="card-body">

                                                <h4><b>Veterinary Availability</b></h4>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="custom-checkbox">
                                                                        <input type="checkbox" class="week_days" id="vet_day_{{$val}}"  name="{{$val}}_veterinary" value="1" @if( $id && $datamain->vet_availablity->{$val} == 1) checked @endif> &nbsp;
                                                                        <label for="vet_day_{{$val}}"> {{ucfirst($val)}}</label>
                                                                    </div>
                                        
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->vet_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_from_veterinary" value="@if($id && $datamain->vet_availablity->$st!='' &&  $datamain->vet_availablity->{$val} == 1){{$datamain->vet_availablity->$st}}@endif" placeholder="Start Time">
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->vet_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_to_veterinary" value="@if($id && $datamain->vet_availablity->$ed!='' &&  $datamain->vet_availablity->{$val} == 1){{$datamain->vet_availablity->$ed}}@endif" placeholder="End Time">
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                </table>
                                        ...
                                        <div class="card mt-4 weekly" style="border-radius: 5px; overflow: hidden;" >
                                            <div class="card-body">
                                                <h4><b>Grooming Availability</b></h4>
                                                <table class="table table-condensed pl-2 mt-2 workinghours" >
                                                        ...
                                                        @foreach($days as $key => $val)
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="custom-checkbox">
                                                                        <input type="checkbox" class="week_days" id="grm_day_{{$val}}"  name="{{$val}}_grooming" value="1" @if( $id && $datamain->gr_availablity->{$val} == 1) checked @endif> &nbsp;
                                                                ...
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->gr_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_from_grooming" value="@if($id && $datamain->gr_availablity->$st!='' &&  $datamain->gr_availablity->{$val} == 1){{$datamain->gr_availablity->$st}}@endif" placeholder="Start Time">
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->gr_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_to_grooming" value="@if($id && $datamain->gr_availablity->$ed!='' &&  $datamain->gr_availablity->{$val} == 1){{$datamain->gr_availablity->$ed}}@endif" placeholder="End Time">
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                </table>
                                        ...
                                        <div class="card mt-4 weekly" style="border-radius: 5px; overflow: hidden;" >
                                            <div class="card-body">
                                                <h4><b>Boarding Services Availability</b></h4>
                                                <table class="table table-condensed pl-2 mt-2 workinghours" >
                                                        ...
                                                        @foreach($days as $key => $val)
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="custom-checkbox">
                                                                        <input type="checkbox" class="week_days" id="brdng_day_{{$val}}"  name="{{$val}}_boarding" value="1" @if( $id && $datamain->brdng_availablity->{$val} == 1) checked @endif> &nbsp;
                                                                        <label for="brdng_day_{{$val}}"> {{ucfirst($val)}}</label>
                                                                    </div>

                                        
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->brdng_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_from_boarding" value="@if($id && $datamain->brdng_availablity->$st!='' &&  $datamain->brdng_availablity->{$val} == 1){{$datamain->brdng_availablity->$st}}@endif" placeholder="Start Time">
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->brdng_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_to_boarding" value="@if($id && $datamain->brdng_availablity->$ed!='' &&  $datamain->brdng_availablity->{$val} == 1){{$datamain->brdng_availablity->$ed}}@endif" placeholder="End Time">
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                </table>
                                        ...
                                        <div class="card mt-4 weekly" style="border-radius: 5px; overflow: hidden;" >
                                            <div class="card-body">
                                                <h4><b>Day Care Reservations Availability</b></h4>
                                                <table class="table table-condensed pl-2 mt-2 workinghours" >
                                                        ...
                                                        @foreach($days as $key => $val)
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="custom-checkbox">
                                                                        <input type="checkbox" class="week_days" id="dc_day_{{$val}}"  name="{{$val}}_daycare" value="1" @if( $id && $datamain->dc_availablity->{$val} == 1) checked @endif> &nbsp;
                                                                        <label for="dc_day_{{$val}}"> {{ucfirst($val)}}</label>
                                                                    </div>
                                        
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->dc_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_from_daycare" value="@if($id && $datamain->dc_availablity->$st!='' &&  $datamain->dc_availablity->{$val} == 1){{$datamain->dc_availablity->$st}}@endif" placeholder="Start Time">
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->dc_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_to_daycare" value="@if($id && $datamain->dc_availablity->$ed!='' &&  $datamain->dc_availablity->{$val} == 1){{$datamain->dc_availablity->$ed}}@endif" placeholder="End Time">
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                </table>
                                        ...
                                        <div class="card mt-4 weekly" style="border-radius: 5px; overflow: hidden;" >
                                            <div class="card-body">
                                                <h4><b>Doggy Playtime Availability</b></h4>
                                                <table class="table table-condensed pl-2 mt-2 workinghours" >
                                                        ...
                                                        @foreach($days as $key => $val)
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="custom-checkbox">
                                                                        <input type="checkbox" class="week_days" id="dpt_day_{{$val}}"  name="{{$val}}_playtime" value="1" @if( $id && $datamain->dpt_availablity->{$val} == 1) checked @endif> &nbsp;
                                                                        <label for="dpt_day_{{$val}}"> {{ucfirst($val)}}</label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->dpt_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_from_playtime" value="@if($id && $datamain->dpt_availablity->$st!='' &&  $datamain->dpt_availablity->{$val} == 1){{$datamain->dpt_availablity->$st}}@endif" placeholder="Start Time">
                                                                </td>
                                                                <td>
                                                                    <input type="text" @if( $id && $datamain->dpt_availablity->{$val} == 1) checked @else disabled @endif class="time form-control"  name="{{$key}}_to_playtime" value="@if($id && $datamain->dpt_availablity->$ed!='' &&  $datamain->dpt_availablity->{$val} == 1){{$datamain->dpt_availablity->$ed}}@endif" placeholder="End Time">
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                </table>

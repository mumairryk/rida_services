...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{url('admin/doctors/create')}}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Doctors</a></div>
    @endif
    <div class="card-body">
                        ...
                        <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/doctors/'.$datarow->id.'/edit')}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    
                                  
                                    @if(check_permission('doctors','Delete'))
                                    <a class="dropdown-item" data-role="unlink"
                                    data-message="Do you want to remove this Doctor?"
                                    href="{{ url('admin/doctors/' . $datarow->id) }}"><i

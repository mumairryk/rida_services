...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            ...
            <form method="post" id="admin-form" action="{{ url('admin/room') }}" enctype="multipart/form-data" data-parsley-validate="true">
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = App.siteUrl('/admin/room');
                        }, 1500);
                    }
